    ...
    <>
      <header
        ...
        className={cx(
          ...
          !isZen &&
            !isEmbedded &&
            'bg-gradient-to-r from-[#0f172a] via-[#1e293b] to-[#0f172a] border-b border-[var(--border-cyan)] backdrop-blur-xl',
            ...
            >
              {!pending ? (
                <span className={cx('flex items-center space-x-2')}>
                  ...
                  {!isEmbedded && (
                    <span className="uppercase tracking-wider text-sm font-mono">{started ? 'Stop' : 'Execute'}</span>
                  )}
                </span>
              ) : (
      ...
      {!isZen && !isEmbedded && <div className="header-gradient-border"></div>}
    </>
  );
}
